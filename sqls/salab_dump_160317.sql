...
INSERT INTO `Members` VALUES (0, 'Sungwon Kang', '강성원', 'prof', NULL, '1997-01-01', 0, NULL),
  ...
  (37, 'Youn-Seok Choi', '최윤석', 'ms', '', '2003-03-16', 1, 2005),
...
INSERT INTO `Publications` VALUES (0, 'INTERNATIONAL_CONFERENCE',
  ...
  (14, 'DOMESTIC_JOURNAL', '문제틀과 아키텍처 패턴의 매칭을 이용한 소프트웨어 아키텍처 설계방법', '한국정보과학회 논문지 제42권 제3호, pp. 341-360, 2015년 3월.', '2015-03-01'),
  (15, 'DOMESTIC_JOURNAL', '조합 시험 설계를 이용한 소프트웨어 제품라인 시험항목 생성 방법', '한국정보과학회논문지 제31권 제10호, pp. 86-93, 2014년 10월.', '2014-10-01'),
  (16, 'INTERNATIONAL_JOURNAL', 'vPMM: A Value Based Process Maturity Model', 'Studies in Computational Intelligence, Vol 208/2009, R. Lee, G. Hu, H. Miao (Eds.), pp. 193-202, Springer-Verlag Berlin Heidelberg 2009. (Presented at the 8th IEEE Int\'l Conf. on Computer and Information Science (ICIS 2009), Shanghai, China, June 1-3, 2009. [Selected as 26 outstanding papers out of 585 submitted and 205 published in the conference proceedings.]', '2009-06-01'),
  (17, 'INTERNATIONAL_CONFERENCE', 'An Efficient Application-Device Matching Method for the Mobile Software Ecosystem', 'The 21st Asia-Pacific Software Engineering Conference, Jeju, Korea, December 1-4, 2014. (Acceptance Rate: 29.6%)', '2014-12-01'),
  (18, 'SCI_JOURNAL', 'A Technique for Measuring Business Process based on Business Values', 'IEICE Transactions on Information and Software Systems. Vol.E98-D,No.4, pp. 911-921, April 2015.', '2015-04-01'),
  (19, 'SCI_JOURNAL', 'Clustering Navigation Sequences to Create Contexts for Guiding Code Navigation', 'Journal of Systems and Software (2013), Vol. 86, 2154- 2165, August 2013.', '2013-08-01'),
  (20, 'SCI_JOURNAL', 'A Method to Optimize the Scope of a Software Product Platform Based On End-User Features', 'Journal of Systems and Software, Vol. 98, pp. 79–106, December 2014.', '2014-12-01'),
  (21, 'SCI_JOURNAL', 'Pairwise Testing for Systems with Data Derived from Real-valued Variable Inputs', 'Software: Practice and Experience, DOI: 10.1002/spe.2295, Oct. 16, 2014.', '2014-10-16'),
  (22, 'INTERNATIONAL_CONFERENCE', 'Developing Object Oriented Designs from Component and Connector Architectures', 'Proceedings of the 12 th Asia-Pacific Software Engineering Conference (APSEC 2005), pp.231~238, Dec. 15 ~ 17, 2005', '2005-12-15'),
...
-- Dump completed on 2016-03-17 13:45:55
